...
<div align="justify">
Las fuciones son programas que realizan una tarea específica. *R* cuenta con una gran variedad permitiendo realizar tareas complejas de manera sencilla. Estas funciones pueden o no recibir argumentos, realizan un procedimiento y devuelven un resultado. En general la sintaxis es la siguiente: _**Nombre_Funcion(Arg1, Arg2, Arg3, ...)**_. Algunas funciones importantes son: 
 ...
 - setwd(): Esta función se utiliza para cambiar el directorio de trabajo. 
...
***
 ...
 - example(): Imprime ejemplos de las funciones.
