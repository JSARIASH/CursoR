...
- Se solicita de manera interactiva información relevante. 
...
Estas variables adquieren relevancia cuando se tienen grandes cantidades de datos.
</div>
...
- colnames(): Obtener el nombre de las columnas. 

- read.csv(): Leer archivos .csv

- apply(): Aplica una función sobre las filas o columnas de una matriz o data frame.

- hist(): Nos permite realizar histogramas. 

- curve(): La utilizaremos para gráficar funciones. 

- plot(): Graficos de dispersión y otros. 

- barplot(): Realizar gráficos de barras. 
...
```{r, highlight=TRUE, results=FALSE}
  ...
  y <- c(2, 4, 5, 6) # y es un vector con los valors 2, 4, 5 y 6. 
...
<div align="justify">
***Listas***: Las listas son un caso especial de vectores en el que los elementos no tienen que ser todos igulaes. Un elemento puede ser un complejo, otro un vector o incluso otra lista. Estas se crean con la función ***list()***.
...
<div align="justify">
En ocaciones ocurre que un conjunto de líneas se repiten en el código, en tal caso podemos encapsularlas para ejecutarlas cuando sea necesario. 
...
- Que encuentre la hipótenusa de un triángulo rectángulo. 
